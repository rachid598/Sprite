...
- **Deux saisons** — un sélecteur dans l'en-tête bascule entre la Saison 4
  (*Override*, 19 Sprites / 74 cases) et la Saison 3 (25 Sprites / 117 cases).
...
- **Application installable** — manifeste + service worker : le site s'installe sur
  ...
  illustrations comprises (228 fichiers pré-mis en cache).
...
assets/sprites/     illustrations des Sprites (209 fichiers .webp 128 px)
...
Les 209 illustrations de `assets/sprites/` sont les visuels des Sprites tirés du jeu,
